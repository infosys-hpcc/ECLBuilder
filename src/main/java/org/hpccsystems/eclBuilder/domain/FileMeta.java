package org.hpccsystems.eclBuilder.domain;
...
public class FileMeta implements Serializable{
    ...
    private Boolean isfileMeta = false;
    private boolean isLogicalFile = false;
    private List<FileMeta> childlist;

    public Boolean getIsfileMeta() {
		return isfileMeta;
	}

	public void setIsfileMeta(Boolean isfileMeta) {
		this.isfileMeta = isfileMeta;
	}
