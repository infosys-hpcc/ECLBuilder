...
public class ECLBuilder implements Serializable  {
	...
	public ECLBuilder(String user_id, String name, String logicalFiles, Timestamp modified_date, String eclbuildercode, String hpccConnid, String wuID, String dsFields) {
		super();
